...
// CPU frequency
#define DISPLAYHW_F_CPU 1000000UL  
...
#define safe_delay_ms(ms) ({_delay_ms(ms); 1; })
...
/* DISPLAY_HW_MODE_SPI_SOFTWARE Подключение по шине SPI (4-х проводной вариант), используя программную реализацию на произвольных пинах */
...
#define SPI_DC_PORT_LETTER B

// Номер пина порта, к которому подключена линия D/C#
#define SPI_DC_PIN_NUM 1
...
#endif /* DISPLAY_HW_MODE_SPI_USART */
